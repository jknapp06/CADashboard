...
essa25_url <- "https://www.cde.ca.gov/sp/sw/t1/documents/essaassistance25.xlsx"
...
essa25 <- read.xlsx(essa25_url, sheet = 2, startRow = 3) |>
  select(
    -c(
  ...
  rename(AssistanceStatus = AssistanceStatus2025, TitleI = TitleI2223)
...
essa <-
  bind_rows(essa25, essa24, essa23, essa22, essa21, essa19, essa18) |>
  pivot_longer(
